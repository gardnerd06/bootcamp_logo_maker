...
// new 
 ...
 class Shapes {
  constructor(color,text,design){
    ...
    this.text = text;
    this.design = design;
    console.log(`you've chosen a ${this.text} shape`);
    console.log(`you've chosen a ${this.design} shape`);
    console.log(`you've chosen a ${this.color} shape`);
  }
 }
